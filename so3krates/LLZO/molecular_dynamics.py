...
data = np.load("/scratch/dy3/jy8620/LLZO/llzo_12_44/MD_testing_warmup/MD_320K/MD_320K.npz")
atoms = Atoms(positions=data['R'][99], numbers=data['z'][99])

T0 = 300 * kB

#print("Running molecular dynamics simulations at "+str(temp)+' K')
...
integratorx = mdx.LangevinX.create(timestep=1.0*fs, temperature=T0, friction=0.5, calculator=calc,fixcm=False)
