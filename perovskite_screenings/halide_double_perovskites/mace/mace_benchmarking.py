...
class Benchmarking:
    ...
    def plot_cumulative_mace_statistics(self):
        ...
        all_data = {
            k: {
                "fluorides": {"stdev_freq": [], "stdev_vel": []},
                "chlorides": {"stdev_freq": [], "stdev_vel": []},
                "bromides": {"stdev_freq": [], "stdev_vel": []},
                "iodides": {"stdev_freq": [], "stdev_vel": []},
            }
            for k in self.available_mace_models
        }
...
class MACEMolecularDynamicsRunner(object):
    ...
    def initialise_structure(self, poscar_path: str = None):
        ...
        self.trajectory_file = poscar_path.replace(
            "SPOSCAR",
    ...
    def equilibrate_structure(self):
        ...
        def print_status():
            ...
            print(
                f"Equilibration Step {step:6d} | E_pot = {epot:.8f} eV | E_kin = {ekin:.8f} eV | T = {temp:.4f} K",
                end=" ",
                flush=True,
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--md_run_this",
        action="store_true",
        help="Run MD simulations with MACE model for this compound.",
    )
    parser.add_argument(
        "--md_run_system",
        type=str,
