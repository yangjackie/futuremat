...
def geometric_fingerprint(crystal: Crystal):
    ...
    return (
        chemistry,
        octahedral_factor(r_m, r_mp, r_x),
        octahedral_mismatch(r_m, r_mp, r_x),
        generalised_tolerance_factor(r_a, r_m, r_mp, r_x),
    )
...
def formation_energy_landscape(db, uids, switch="sigma", plot_anion="F"):
    ...
    if switch in ["A-site"]:
        from perovskite_screenings.analysis import (
            halide_C,
            halide_B,
            halide_A,
            tolerance_factor,
        ...
        from perovskite_screenings.analysis import (
            octahedral_factor as pv_octahedral_factor,
        )
    ...
    for uid in uids:
        ...
        if (formation_energy is not None) and (sigma is not None):
            (
                ...
                octahedral_factor,
                octahedral_mismatch,
                generalised_tolerance_factor,
            ) = geometric_fingerprint(crystal)
    ...
    if switch == "formation_energy":
        plt.scatter(
            F_data_dict["octahedral_factors"],
            F_data_dict["tolerance_factors"],
            marker="^",
            norm=mpl.colors.Normalize(vmin=min_energy * 1.1, vmax=max_energy * 1.1),
            c=F_data_dict["formation_energies"],
            edgecolor=None,
            alpha=0.45,
            s=45,
        ...
        plt.scatter(
            Cl_data_dict["octahedral_factors"],
            Cl_data_dict["tolerance_factors"],
            marker="s",
            norm=mpl.colors.Normalize(vmin=min_energy * 1.1, vmax=max_energy * 1.1),
            c=Cl_data_dict["formation_energies"],
            edgecolor=None,
            alpha=0.45,
            s=45,
            cmap=plt.get_cmap("RdYlGn"),
        ...
        plt.scatter(
            Br_data_dict["octahedral_factors"],
            Br_data_dict["tolerance_factors"],
            marker="d",
            norm=mpl.colors.Normalize(vmin=min_energy * 1.1, vmax=max_energy * 1.1),
            c=Br_data_dict["formation_energies"],
            edgecolor=None,
            alpha=0.45,
            s=45,
            cmap=plt.get_cmap("RdYlGn"),
        ...
        plt.scatter(
            I_data_dict["octahedral_factors"],
            I_data_dict["tolerance_factors"],
            marker="p",
            norm=mpl.colors.Normalize(vmin=min_energy * 1.1, vmax=max_energy * 1.1),
            c=I_data_dict["formation_energies"],
            edgecolor=None,
            alpha=0.45,
            s=45,
            cmap=plt.get_cmap("RdYlGn"),
        ...
        plt.scatter(
            ...
            c=F_data_dict["octahedral_mismatch"],
            edgecolor=None,
            alpha=0.45,
            s=45,
            cmap=plt.get_cmap("RdYlGn"),
        ...
        plt.scatter(
            ...
            marker="s",
            norm=mpl.colors.Normalize(vmin=0.0, vmax=0.5),
            c=Cl_data_dict["octahedral_mismatch"],
            edgecolor=None,
            alpha=0.45,
            s=45,
            cmap=plt.get_cmap("RdYlGn"),
        ...
        plt.scatter(
            ...
            marker="d",
            norm=mpl.colors.Normalize(vmin=0.0, vmax=0.5),
            c=Br_data_dict["octahedral_mismatch"],
            edgecolor=None,
            alpha=0.45,
            s=45,
            cmap=plt.get_cmap("RdYlGn"),
        ...
        plt.scatter(
            ...
            marker="p",
            norm=mpl.colors.Normalize(vmin=0.0, vmax=0.5),
            c=I_data_dict["octahedral_mismatch"],
            edgecolor=None,
            alpha=0.45,
            s=45,
            cmap=plt.get_cmap("RdYlGn"),
        ...
        plt.scatter(
            all_data_dict["octahedral_factors"],
            all_data_dict["tolerance_factors"],
            marker="s",
            c=colors,
            edgecolor=None,
            alpha=0.25,
    ...
    if switch == "formation_energy":
        ...
        legend_elements = [
            Patch(facecolor="#344d90", edgecolor="k", label="A=Li"),
...
def get_band_gap_energy_dict():
    ...
    response = mpr.session.get(
        "https://materialsproject.org/materials/10.17188/1476059"
    )
    text = response.text
    for t in text.split():
        if "mp-" in t:
...
def sigma_landscape(db, uids, x="frequency", y=None):
    ...
    if x == "formation_energies":
        ...
        legend_elements = [
            Patch(facecolor=color_dict["F"], edgecolor="k", label="X=F"),
        ...
        plt.scatter(
            promising_Eg, promising_sigma, marker="s", s=30, edgecolor="k", c="k"
        )
        legend_elements = [
            Patch(facecolor=color_dict["F"], edgecolor="k", label="X=F"),
            Patch(facecolor=color_dict["Cl"], edgecolor="k", label="X=Cl"),
