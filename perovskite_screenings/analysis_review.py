...
def formation_energy_sigma_landscape(systems='chalcogenides'):
    ...
    plt.xlabel("$\\Delta E_{f}^{Pm\\bar{3}m}$ (eV/atom)")
...
if __name__ == "__main__":
    ...
    formation_energy_sigma_landscape(systems='chalcogenides')